...
# PURPOSE: Insight Library routes for retrieval, filtering, and engagement generation.
# PRD_REF: docs/PRD.md §11.6, §24 v0.6
# WHY_REF: docs/why-graph.xml#MOD-WEB-ROUTES-INSIGHTS
# SCOPE: library list; audience/format filters; deterministic engagement action
# INVARIANTS:
# - Insight Library renders published DB Insights directly; it is not an approval queue.
# - Engagement action delegates to the deterministic v0.6a service and makes no model calls.
# :END_MODULE_CONTRACT
